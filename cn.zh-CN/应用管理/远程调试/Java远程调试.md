...
7.  在**远程调试设置**面板中，设置远程调试参数，单击**确定**。
    ...
    |参数|说明|
    |--|--|
    |请选择公网SLB|选择SLB完成本地与远程实例的连接。如果您之前没有创建过SLB，您可以选择**新建SLB**来创建SLB进行连接。关于SLB的详细说明，请参见[什么是负载均衡](/cn.zh-CN/CLB产品简介/什么是负载均衡.md)。**说明：** 使用SLB时会产生额外费用，SLB的计费方式，请参见[按量计费](/cn.zh-CN/CLB产品定价/按量计费.md)。 |
