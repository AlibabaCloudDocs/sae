...
4.  在**镜像同步**对话框中输入以下信息并单击**确认**。
    ...
    ![acr_db_image_sync](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/1523960061/p127728.png)
...
4.  在**应用部署配置**页签，配置相关参数。
    ...
    ![sc_config_image](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/1088560061/p127139.png)
